...
<head>
    ...
    <title>Admin Settings | Happy Paws</title>
        ...
        <main class="content-area">
            <div class="subpage-card">
                <div class="subpage-header">
                    <h1 class="subpage-title">System Settings & Configuration</h1>
                    <button class="panel-action-btn" style="border:none; cursor:pointer; font-size:0.9rem; padding:8px 16px;">Save Preferences</button>
                </div>
                <div class="clinic-info-list">
                    <div class="clinic-info-item">
                        <div class="clinic-detail-content">
                            <span class="clinic-detail-label">System Notifications</span>
                            <span class="clinic-detail-value">Email & SMS Alert Notifications Active</span>
                        </div>
                    </div>
                    <div class="clinic-info-item">
                        <div class="clinic-detail-content">
                            <span class="clinic-detail-label">Database Backup Schedule</span>
                            <span class="clinic-detail-value">Daily Automatic Backup at 02:00 AM UTC</span>
                        </div>
                    </div>
                </div>
            </div>
