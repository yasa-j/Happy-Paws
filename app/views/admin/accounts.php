...
<head>
    ...
    <title>Staff Accounts | Happy Paws Admin</title>
        ...
        <main class="content-area">
            <div class="subpage-card">
                <div class="subpage-header">
                    <h1 class="subpage-title">Staff Accounts & Security Credentials</h1>
                    <button class="panel-action-btn" style="border:none; cursor:pointer; font-size:0.9rem; padding:8px 16px;">Create Account</button>
                </div>
                <table class="report-table">
                    ...
                    <tbody>
                        <?php foreach ($data['staffList'] as $staff): ?>
                            <tr>
                                <td><strong><?php echo strtolower(str_replace(['Dr. ', ' '], ['', '.'], $staff['name'])); ?></strong></td>
