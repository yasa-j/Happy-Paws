...
<head>
    ...
    <title>Reports Overview | Happy Paws Admin</title>
        ...
        <main class="content-area">
            <div class="subpage-card">
                <div class="subpage-header">
                    <h1 class="subpage-title">Reports Management & Export Center</h1>
                    <button class="panel-action-btn" style="border:none; cursor:pointer; font-size:0.9rem; padding:8px 16px;">Generate Custom Report</button>
                </div>
                <div class="metrics-row">
                    <div class="metric-card"><span class="metric-card-label">Monthly Financial PDF</span><span class="metric-card-value">Ready</span></div>
                    <div class="metric-card"><span class="metric-card-label">Clinical Outcomes</span><span class="metric-card-value">Generated</span></div>
                    <div class="metric-card"><span class="metric-card-label">Staff Audit Log</span><span class="metric-card-value">Up to date</span></div>
                </div>
            </div>
        </main>
    </div>
