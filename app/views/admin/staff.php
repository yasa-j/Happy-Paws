...
<head>
    ...
    <title>Staff Management | Happy Paws Admin</title>
        ...
        <main class="content-area">
            <div class="subpage-card">
                <div class="subpage-header">
                    <h1 class="subpage-title">Staff Management</h1>
                    <button class="panel-action-btn" style="border:none; cursor:pointer; font-size:0.9rem; padding:8px 16px;">+ Add New Staff Member</button>
                </div>

                <div class="metrics-row" style="margin-bottom: 24px;">
                    <div class="metric-card">
                        <span class="metric-card-label">Total Staff</span>
                        <span class="metric-card-value"><?php echo count($data['staffList']); ?></span>
                    </div>
                    <div class="metric-card">
                        <span class="metric-card-label">Veterinarians</span>
                        <span class="metric-card-value">2</span>
                    </div>
                    <div class="metric-card">
                        <span class="metric-card-label">Technicians</span>
                        <span class="metric-card-value">1</span>
                    </div>
                    <div class="metric-card">
                        <span class="metric-card-label">On Duty Today</span>
                        <span class="metric-card-value">4</span>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="staff-profile-cell">
                                        <img src="<?php echo $staff['avatar']; ?>" class="staff-avatar-mini">
                                        <div>
                                ...
                                <td><span class="role-badge"><?php echo htmlspecialchars($staff['role']); ?></span></td>
                                <td><?php echo htmlspecialchars($staff['phone']); ?></td>
                                <td><?php echo htmlspecialchars($staff['joined']); ?></td>
                                <td>
                                    <span class="status-badge <?php echo $staff['status'] === 'On Leave' ? 'on-leave' : 'active'; ?>">
                                        <?php echo htmlspecialchars($staff['status']); ?>
                                    </span>
                                </td>
                                <td>
                                    <a href="#" style="color:#006f6a; font-weight:600; text-decoration:none; margin-right:12px;">Edit</a>
                                    <a href="#" style="color:#ef4444; font-weight:600; text-decoration:none;">Remove</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
