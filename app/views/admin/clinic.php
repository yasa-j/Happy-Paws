...
<head>
    ...
    <title>Clinic Management | Happy Paws Admin</title>
        ...
        <main class="content-area">
            <div class="subpage-card">
                <div class="subpage-header">
                    <h1 class="subpage-title">Clinic Operations & Facility Management</h1>
                </div>
                <div class="metrics-row" style="margin-bottom: 24px;">
                    <div class="metric-card"><span class="metric-card-label">Active Examination Rooms</span><span class="metric-card-value">12 / 12</span></div>
                    <div class="metric-card"><span class="metric-card-label">Surgical Suites</span><span class="metric-card-value">4 Ready</span></div>
                    <div class="metric-card"><span class="metric-card-label">Pharmacy Inventory Items</span><span class="metric-card-value">1,480</span></div>
                    <div class="metric-card"><span class="metric-card-label">Facility Status</span><span class="metric-card-value" style="color:#10b981;">Fully Operational</span></div>
                </div>
                <p style="color:var(--text-secondary);">Manage room allocations, medical equipment maintenance logs, facility licenses, and inventory re-orders.</p>
            </div>
        </main>
    </div>
</div>
